...
func TestNewRequest(t *testing.T) {
	t.Run("defaults", func(t *testing.T) {
		...
		got, err := NewRequest(ctx, "test", body)
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("msgpack option", func(t *testing.T) {
		...
		got, err := NewRequest(ctx, "test", body, WithEncodeMsgpack())
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("proto option", func(t *testing.T) {
		...
		got, err := NewRequest(ctx, "test", body, WithEncodeProto())
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("proto option w/non proto message", func(t *testing.T) {
		...
		_, err := NewRequest(context.Background(), "test", body, WithEncodeProto())
		if err == nil {
...
func TestRequest_Decode(t *testing.T) {
	t.Run("decode json", func(t *testing.T) {
		body := map[string]string{"hello": "world"}
		r, err := NewRequest(context.Background(), "test", body)
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("decode msgpack", func(t *testing.T) {
		body := map[string]string{"hello": "world"}
		r, err := NewRequest(context.Background(), "test", body, WithEncodeMsgpack())
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("decode proto", func(t *testing.T) {
		...
		r, err := NewRequest(context.Background(), "test", body, WithEncodeProto())
		if err != nil {
			t.Fatal(err)
		}
